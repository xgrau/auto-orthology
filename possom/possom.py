...
arp.add_argument("-phy", "--phy",  required=True,  help="folder with phylogenies")
arp.add_argument("-suf", "--suf",  required=True,  help="suffix of phylogenies in folder")
arp.add_argument("-out", "--out",  required=True,  help="prefix for output")
#### THIS ARGUMENT SHOULD BE THE FORMATTED TABLE
arp.add_argument("-ort", "--ort",  required=True,  help="Orthology.txt table-like file produced by orthofinder")
arp.add_argument("-ani", "--ani",  required=True,  help="which analysis to perform: \"main\" to analyse all genes, \"opti\" to find optimal inflation value")
arp.add_argument("-inf", "--inf",  required=False, default=1.1, help="if analysis is \"main\", which inflation value to use? Default is 1.1")
arp.add_argument("-nopt", "--nopt", required=False, default=500, help="if analysis is \"opti\", how many phylogenies should we examine for optimisation? Default is 500")
arp.add_argument("-print", "--print", required=False, default=False, help="print new tree with defined clusters?")
